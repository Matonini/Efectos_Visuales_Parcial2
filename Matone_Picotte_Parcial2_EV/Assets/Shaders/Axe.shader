...
Shader "Axe"
{
	Properties
	{
		...
		[ASEEnd][ASEBegin]_scene__Camp_BaseColor("scene__Camp_BaseColor", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _scene__Camp_BaseColor_ST;
			...
			#endif
			CBUFFER_END
			sampler2D _scene__Camp_BaseColor;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_scene__Camp_BaseColor = IN.ase_texcoord7.xy * _scene__Camp_BaseColor_ST.xy + _scene__Camp_BaseColor_ST.zw;
				
				float time13 = cos( _TimeParameters.x );
				float2 voronoiSmoothId13 = 0;
				float2 coords13 = IN.ase_texcoord7.xy * (float)2;
				float2 id13 = 0;
				float2 uv13 = 0;
				...
				float fresnelNode12 = ( voroi13 + 1.0 * pow( 1.0 - fresnelNdotV12, 5.0 ) );
				float3 temp_cast_2 = (fresnelNode12).xxx;
				
				float3 Albedo = tex2D( _scene__Camp_BaseColor, uv_scene__Camp_BaseColor ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_scene__Camp_BaseColor = IN.ase_texcoord2.xy * _scene__Camp_BaseColor_ST.xy + _scene__Camp_BaseColor_ST.zw;
				...
				float time13 = cos( _TimeParameters.x );
				float2 voronoiSmoothId13 = 0;
				float2 coords13 = IN.ase_texcoord2.xy * (float)2;
				float2 id13 = 0;
				float2 uv13 = 0;
				float voroi13 = voronoi13( coords13, time13, id13, uv13, 0, voronoiSmoothId13 );
...
/*ASEBEGIN
Version=18935
882;73;645;653;1115.085;36.6907;1;False;False
Node;AmplifyShaderEditor.SimpleTimeNode;16;-1242.77,185.8755;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.CosOpNode;15;-990.7131,180.3956;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;18;-945.0854,458.3093;Inherit;False;Constant;_Int0;Int 0;1;0;Create;True;0;0;0;False;0;False;2;0;False;0;1;INT;0
Node;AmplifyShaderEditor.VoronoiNode;13;-746.8746,188.615;Inherit;True;0;0;1;0;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.FresnelNode;12;-512.624,177.6556;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;8;-581.1748,-108.7898;Inherit;True;Property;_scene__Camp_BaseColor;scene__Camp_BaseColor;0;0;Create;True;0;0;0;False;0;False;-1;a4f24a509462a84488c0e54da8871ed9;a4f24a509462a84488c0e54da8871ed9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=CD03A6196BE971CFF66840EFA441830D8C4620B5